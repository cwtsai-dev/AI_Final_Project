...
# split train into batches for training
...
# use the whole train time series as one batch
...
def model_predict(args, model, test_loader):
    # read the index benchmark data, used to compute the Information Ratio (IR)
